...
movie.get_list_movie_genres = (genre_id) => {
  return new Promise((resolve, reject) => {
    let params = [genre_id];
    let query = `select * from "Movie" M inner join "MovieGenres" MG on M.movie_id = MG.movie_id inner join "Genre" G on MG.genre_id = G.genre_id where G.genre_id = $1 limit 20`;
